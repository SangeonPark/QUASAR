...
def build_network(net_name, ae_net=None):
    ...
    implemented_networks = ('mnist_LeNet', 'mnist_DGM_M2', 'mnist_DGM_M1M2',
                            ...
                            'lhc_mlp', 'arrhythmia_mlp', 'cardio_mlp', 'satellite_mlp', 'satimage-2_mlp', 'shuttle_mlp',
                            'thyroid_mlp',
    ...
    if net_name == 'lhc_mlp':
        net = MLP(x_dim=12, h_dims=[40, 30, 20, 10], rep_dim=4, bias=True)
...
def build_autoencoder(net_name):
    ...
    implemented_networks = ('mnist_LeNet', 'mnist_DGM_M1M2',
                            ...
                            'cifar10_LeNet', 'cifar10_DGM_M1M2', 'lhc_mlp',
    ...
    if net_name == 'lhc_mlp':
        ae_net = MLP_Autoencoder(x_dim=12, h_dims=[40, 30, 20, 10], rep_dim=4, bias=True)
