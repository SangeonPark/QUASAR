...
def makeHist(iName,iCut,iBBTree,iBkgTree):
    lData1 = r.TH1F("bbhist"+iName,"bbhist"+iName,50,2500,7000)
    lBkg1  = r.TH1F("bkhist"+iName,"bkhist"+iName,50,2500,7000) 
...
if __name__ == "__main__":#blackbox2-CutFromMap.root
    ...
    cuts=[]
    cuts.append("loss2 > -5.5   && loss1 < 50000")
    cuts.append("loss2 > -5.5   && loss1 < 12000")
    cuts.append("loss2 > -5.5   && loss1 < 1000")    
    cuts.append("loss2 > -5.5   && loss1 < 800")
    cuts.append("loss2 > -5.5   && loss1 < 600")
    ...
    for i0 in range(len(cuts)):
        pData1,pBkg1=makeHist(label[i0],cuts[i0],lBBTree,lBkgTree)
        masses1,pvalues1=fitFunc(pData1,pBkg1,"BB1",3000,6000,150,iBkgTemp)
        #masses2,pvalues2=pvalue(lData1) 
